...
<body class="bg-gray-100">
    <nav class="bg-blue-800 text-white p-4">
        <div class="container mx-auto flex justify-between items-center">
            <h1 class="text-xl font-bold">Manage Departments</h1>
        ...
        <div class="bg-white rounded-lg shadow p-6 mb-6">
            ...
            <form method="POST" class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="text" name="department_name" required class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Department Head</label>
                    <input type="text" name="department_head" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Office Location</label>
                    <input type="text" name="office_location" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500">
                </div>
                <div>
        ...
        <div class="bg-white rounded-lg shadow p-6">
            ...
            <div class="overflow-x-auto">
                <table class="w-full table-auto">
                    <thead>
                        <tr class="border-b">
                            <th class="text-left py-2">Department Name</th>
                    ...
                    <tbody>
                        ...
                        <tr class="border-b hover:bg-gray-50">
                            <td class="py-2 font-medium"><?php echo htmlspecialchars($department['department_name']); ?></td>
                            <td class="py-2"><?php echo htmlspecialchars($department['department_head'] ?? 'N/A'); ?></td>
                            <td class="py-2"><?php echo htmlspecialchars($department['office_location'] ?? 'N/A'); ?></td>
                            <td class="py-2"><?php echo htmlspecialchars($department['phone_number'] ?? 'N/A'); ?></td>
                            <td class="py-2"><?php echo htmlspecialchars($department['email'] ?? 'N/A'); ?></td>
                            <td class="py-2">
                                <button onclick="editDepartment(<?php echo htmlspecialchars(json_encode($department)); ?>)" class="bg-yellow-500 text-white px-2 py-1 rounded text-sm hover:bg-yellow-600 mr-2">Edit</button>
        ...
        <div class="bg-white p-6 rounded-lg max-w-md w-full mx-4">
            ...
            <form method="POST" id="editForm">
                ...
                <div class="space-y-4">
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Department Name</label>
                        <input type="text" name="department_name" id="edit_department_name" required class="w-full px-3 py-2 border border-gray-300 rounded-lg">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Department Head</label>
                        <input type="text" name="department_head" id="edit_department_head" class="w-full px-3 py-2 border border-gray-300 rounded-lg">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Office Location</label>
                        <input type="text" name="office_location" id="edit_office_location" class="w-full px-3 py-2 border border-gray-300 rounded-lg">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Phone Number</label>
    ...
    <script>
        function editDepartment(department) {
            ...
            document.getElementById('edit_office_location').value = department.office_location || '';
            document.getElementById('edit_phone_number').value = department.phone_number || '';
